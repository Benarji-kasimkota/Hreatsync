// ── Shared zone data ──
const ZONES = [
  { name: 'REST',     min: 30,  max: 59,  color: '#4fc3f7', bg: '#060d14', desc: 'Deep rest state' },
  { name: 'NORMAL',   min: 60,  max: 99,  color: '#00e5ff', bg: '#0a0e1a', desc: 'Normal resting range' },
  { name: 'WARM-UP',  min: 100, max: 114, color: '#69f0ae', bg: '#071208', desc: 'Light activity zone' },
  { name: 'FAT BURN', min: 115, max: 134, color: '#ffeb3b', bg: '#141000', desc: 'Fat oxidation zone' },
  { name: 'CARDIO',   min: 135, max: 159, color: '#ffa726', bg: '#140900', desc: 'Aerobic conditioning' },
  { name: 'PEAK',     min: 160, max: 179, color: '#ef5350', bg: '#140404', desc: 'High-intensity exertion' },
  { name: 'DANGER',   min: 180, max: 220, color: '#e040fb', bg: '#100010', desc: 'Extreme — use caution' },
];
